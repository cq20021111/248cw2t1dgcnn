...
def get_graph_feature(x, k=20, idx=None):
    """
    Construct the graph feature for EdgeConv.
    x: (batch_size, num_dims, num_points)
    k: int
...
class DGCNN(nn.Module):
    ...
    This is an Advanced Model compared to PointNet.
    """
    ...
    def forward(self, x):
        ...
        # x is expected to be (Batch, Channels, Num_Points)
        ...
        x = torch.cat((x1, x2), 1) # Shape: (Batch, 2048)
